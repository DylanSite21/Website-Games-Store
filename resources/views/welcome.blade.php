...
<body class="background text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4">
                @auth
                    <a href="{{ url('/home') }}"
                        class="inline-block px-5 py-1.5 font-bold dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">
                        Home
                    </a>
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block px-5 py-1.5 font-bold dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-sm leading-normal">
                        Log in
                    </a>
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[1rem] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-[#161615c4] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none backdrop:blur-[2px]">
                <h1 class="mb-1 font-extrabold">Let's Play!</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Welcome to Web Games Store <br>
                    Discover, explore, and purchase your favorite games easily and securely.</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            Browse popular and <span
                                class="font-medium border-b-2 border-[#ff2f00] dark:border-[#ff1500]">trending
                                games</span>
                    ...
                    <li
                        ...
                        <span>
                            Manage your game library anytime
                        </span>
                    </li>
                </ul>
